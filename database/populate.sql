...
INSERT INTO Pet(idphoto, idowner, name, age, location, species, size, status) VALUES (2, 1, "cao", 3, "porto", "cão", "pequeno", 1);
INSERT INTO Pet(idphoto, idowner, name, age, location, species, size, status) VALUES (3, 1, "gato", 9, "porto", "gato", "médio", 1);
INSERT INTO Pet(idphoto, idowner, name, age, location, species, size, status) VALUES (4, 1, "covid", 4, "lisboa", "gato", "médio", 1);
INSERT INTO Pet(idphoto, idowner, name, age, location, species, size, status) VALUES (5, 1, "shiba", 3, "madeira", "cão", "médio", 0);
INSERT INTO Pet(idphoto, idowner, name, age, location, species, size, status) VALUES (6, 1, "asd", 4, "asd", "cão", "pequeno", 1);
